...
document.addEventListener('DOMContentLoaded', function() {
    const houses = {
        ...
        'slytherin': {
            ...
            banner: 'https://static.wikia.nocookie.net/greatanimetournament/images/e/ee/44454inna.jpg/revision/latest/scale-to-width-down/1200?cb=20221119144855&path-prefix=ru'
        },
        'ravenclaw': {
            name: 'Когтевран',
